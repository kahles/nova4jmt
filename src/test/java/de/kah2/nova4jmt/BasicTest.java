...
import static de.kah2.nova4jmt.Aberration.ln_get_equ_aber;
import static de.kah2.nova4jmt.Airmass.ln_get_airmass;
import static de.kah2.nova4jmt.Airmass.ln_get_alt_from_airmass;
import static de.kah2.nova4jmt.AngularSeparation.ln_get_angular_separation;
import static de.kah2.nova4jmt.AngularSeparation.ln_get_rel_posn_angle;
import static de.kah2.nova4jmt.ApparentPosition.ln_get_apparent_posn;
import static de.kah2.nova4jmt.DynamicalTime.ln_get_jde;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_body_earth_dist;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_body_equ_coords;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_body_next_rst;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_body_rst;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_body_solar_dist;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_geo_rect_posn;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_helio_rect_posn;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_orbit_avel;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_orbit_len;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_orbit_pvel;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_orbit_vel;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_radius_vector;
import static de.kah2.nova4jmt.EllipticMotion.ln_get_ell_true_anomaly;
import static de.kah2.nova4jmt.EllipticMotion.ln_solve_kepler;
import static de.kah2.nova4jmt.HeliocentricTime.ln_get_heliocentric_time_diff;
import static de.kah2.nova4jmt.HyperbolicMotion.ln_get_hyp_body_equ_coords;
import static de.kah2.nova4jmt.HyperbolicMotion.ln_get_hyp_body_next_rst_horizon;
import static de.kah2.nova4jmt.HyperbolicMotion.ln_get_hyp_body_solar_dist;
import static de.kah2.nova4jmt.HyperbolicMotion.ln_get_hyp_radius_vector;
import static de.kah2.nova4jmt.HyperbolicMotion.ln_get_hyp_true_anomaly;
import static de.kah2.nova4jmt.JulianDay.ln_date_to_zonedate;
import static de.kah2.nova4jmt.JulianDay.ln_get_date;
import static de.kah2.nova4jmt.JulianDay.ln_get_day_of_week;
import static de.kah2.nova4jmt.JulianDay.ln_get_julian_day;
import static de.kah2.nova4jmt.JulianDay.ln_get_julian_from_sys;
import static de.kah2.nova4jmt.JulianDay.ln_zonedate_to_date;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_body_earth_dist;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_body_equ_coords;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_body_solar_dist;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_geo_rect_posn;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_helio_rect_posn;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_radius_vector;
import static de.kah2.nova4jmt.ParabolicMotion.ln_get_par_true_anomaly;
import static de.kah2.nova4jmt.Parallax.ln_get_parallax;
import static de.kah2.nova4jmt.Precession.ln_get_equ_prec;
import static de.kah2.nova4jmt.Precession.ln_get_equ_prec2;
import static de.kah2.nova4jmt.ProperMotion.ln_get_equ_pm;
import static de.kah2.nova4jmt.RiseSet.ln_get_body_next_rst_horizon_future;
import static de.kah2.nova4jmt.RiseSet.ln_get_object_next_rst;
import static de.kah2.nova4jmt.RiseSet.ln_get_object_next_rst_horizon;
import static de.kah2.nova4jmt.RiseSet.ln_get_object_rst;
import static de.kah2.nova4jmt.RiseSet.ln_get_object_rst_horizon;
import static de.kah2.nova4jmt.SiderealTime.ln_get_apparent_sidereal_time;
import static de.kah2.nova4jmt.SiderealTime.ln_get_mean_sidereal_time;
import static de.kah2.nova4jmt.Transform.ln_get_ecl_from_equ;
import static de.kah2.nova4jmt.Transform.ln_get_equ_from_ecl;
import static de.kah2.nova4jmt.Transform.ln_get_equ_from_gal;
import static de.kah2.nova4jmt.Transform.ln_get_gal_from_equ;
import static de.kah2.nova4jmt.Transform.ln_get_gal_from_equ2000;
import static de.kah2.nova4jmt.Transform.ln_get_hrz_from_equ;
import static de.kah2.nova4jmt.Utility.ln_deg_to_dms;
import static de.kah2.nova4jmt.Utility.ln_dms_to_deg;
import static de.kah2.nova4jmt.Utility.ln_equ_to_hequ;
import static de.kah2.nova4jmt.Utility.ln_hequ_to_equ;
import static de.kah2.nova4jmt.Utility.ln_hlnlat_to_lnlat;
import static de.kah2.nova4jmt.Utility.ln_hms_to_deg;
import static de.kah2.nova4jmt.Utility.ln_lnlat_to_hlnlat;
import static de.kah2.nova4jmt.api.Constants.B1900;
import static de.kah2.nova4jmt.api.Constants.JD2000;
import static de.kah2.nova4jmt.api.Constants.JD2050;
import static de.kah2.nova4jmt.solarsystem.Earth.ln_get_earth_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Earth.ln_get_earth_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_disk;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_equ_sdiam;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_magnitude;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_phase;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_pol_sdiam;
import static de.kah2.nova4jmt.solarsystem.Jupiter.ln_get_jupiter_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_bright_limb;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_disk;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_ecl_coords;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_equ_coords_prec;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_geo_posn;
import static de.kah2.nova4jmt.solarsystem.Lunar.ln_get_lunar_phase;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_disk;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_magnitude;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_phase;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_sdiam;
import static de.kah2.nova4jmt.solarsystem.Mars.ln_get_mars_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_disk;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_magnitude;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_phase;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_sdiam;
import static de.kah2.nova4jmt.solarsystem.Mercury.ln_get_mercury_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_disk;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_magnitude;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_phase;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_sdiam;
import static de.kah2.nova4jmt.solarsystem.Neptune.ln_get_neptune_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_disk;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_magnitude;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_phase;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_sdiam;
import static de.kah2.nova4jmt.solarsystem.Pluto.ln_get_pluto_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_disk;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_equ_sdiam;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_magnitude;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_phase;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_pol_sdiam;
import static de.kah2.nova4jmt.solarsystem.Saturn.ln_get_saturn_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Solar.LN_SOLAR_STANDART_HORIZON;
import static de.kah2.nova4jmt.solarsystem.Solar.ln_get_solar_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Solar.ln_get_solar_geom_coords;
import static de.kah2.nova4jmt.solarsystem.Solar.ln_get_solar_rst;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_disk;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_magnitude;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_phase;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_sdiam;
import static de.kah2.nova4jmt.solarsystem.Uranus.ln_get_uranus_solar_dist;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_disk;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_earth_dist;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_equ_coords;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_helio_coords;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_magnitude;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_phase;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_rst;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_sdiam;
import static de.kah2.nova4jmt.solarsystem.Venus.ln_get_venus_solar_dist;

import java.math.BigDecimal;
import java.util.Locale;

import de.kah2.nova4jmt.Nutation;
import de.kah2.nova4jmt.api.LnDate;
import de.kah2.nova4jmt.api.LnDms;
import de.kah2.nova4jmt.api.LnEllOrbit;
import de.kah2.nova4jmt.api.LnEquPosn;
import de.kah2.nova4jmt.api.LnGalPosn;
import de.kah2.nova4jmt.api.LnHelioPosn;
import de.kah2.nova4jmt.api.LnHms;
import de.kah2.nova4jmt.api.LnHrzPosn;
import de.kah2.nova4jmt.api.LnHypOrbit;
import de.kah2.nova4jmt.api.LnLnlatPosn;
import de.kah2.nova4jmt.api.LnNutation;
import de.kah2.nova4jmt.api.LnParOrbit;
import de.kah2.nova4jmt.api.LnRectPosn;
import de.kah2.nova4jmt.api.LnRstTime;
import de.kah2.nova4jmt.api.LnZoneDate;
import de.kah2.nova4jmt.api.LnhEquPosn;
import de.kah2.nova4jmt.api.LnhLnlatPosn;
import de.kah2.nova4jmt.util.IGetEquBodyCoords;

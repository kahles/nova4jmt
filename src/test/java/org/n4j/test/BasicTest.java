...
//ignore
    ...
    int transform_test()
    {
        LnhEquPosn hobject, hpollux;
        LnhLnlatPosn hobserver, hecl;
        LnEquPosn object, pollux, equ;
        LnHrzPosn hrz;
        LnLnlatPosn observer, ecl;
        LnGalPosn gal;
        double JD;
        LnDate date;
        int failed = 0;
    ...
    {
        double JD;
        LnhEquPosn hobject, hpm;
        LnEquPosn object, pm, pos; 
        int failed = 0;
    ...
    int lunar_test ()
    {
        ...
        System.out.format( "lunar distance km %f\n", ln_get_lunar_earth_dist(JD));
    ...
    int utility_test()
    {
        ...
        System.out.format("TEST deg %f ==> deg %c%d min %d sec %f\n",

...
/*! \fn double ln_get_julian_day(LnDate *date)
...
/*! \fn unsigned int ln_get_day_of_week(LnDate *date)
* \param date Date required
...
/*! \fn void ln_get_date(double JD, LnDate *date)
* \param JD Julian day
...
/*! \fn void ln_get_date_from_sys(LnDate *date)
...
/*! \fn double ln_get_julian_local_date(LnZonedate* zonedate)
...
/*! \fn void ln_get_local_date(double JD, LnZonedate *zonedate)
* \param JD Julian day
...
*/
public static void ln_get_local_date(double JD, LnZoneDate zonedate)
{
    LnDate date= new LnDate();
    long gmtoff;
...
/*! \fn int ln_get_date_from_mpc(LnDate *date, char *mpc_date)
* \param date Pointer to new calendar date.
...
/*! \fn void ln_date_to_zonedate(LnDate *date, LnZonedate *zonedate, long gmtoff)
...
*/
public static void ln_date_to_zonedate(LnDate date,
    LnZoneDate zonedate, long gmtoff)
{
    double jd;
...
/*! \fn void ln_zonedate_to_date(LnZonedate *zonedate, LnDate *date)
* \param zonedate Ptr to zonedate
* \param date Ptr to date
*

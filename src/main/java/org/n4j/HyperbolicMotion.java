...
public class HyperbolicMotion {
	...
	/*
	 * ! \fn double ln_solve_hyp_barker (double Q1, double G, double t); \param
	 * Q1 See 35.0 \param G See 35.0 \param t Time since perihelion in days
	 ...
	 * \param q Perihelion distance in AU \param e Orbit eccentricity \param t
	 * Time since perihelion \return True anomaly (degrees)
	 * 
	 ...
	 * \param q Perihelion distance in AU \param e Orbit eccentricity \param t
	 * Time since perihelion in days \return Radius vector AU
	 * 
	...
	/*
	 * ! \fn void ln_get_hyp_helio_rect_posn(LnHypOrbit orbit, double JD,
	...
	/*
	 * ! \fn void ln_get_hyp_geo_rect_posn(LnHypOrbit orbit, double JD,
	 * LnRectPosn posn); \param orbit Orbital parameters of object. \param JD
	 * Julian day \param posn Position pointer to store objects position
	 * 
	...
	/*
	 * ! \fn void ln_get_hyp_body_equ_coords(double JD, LnHypOrbit orbit,
	...
	/*
	 * ! \fn double ln_get_hyp_body_earth_dist(double JD, LnHypOrbit orbit)
	...
	/*
	 * ! \fn double ln_get_hyp_body_solar_dist(double JD, LnHypOrbit orbit)
	...
	/*
	 * ! \fn double ln_get_hyp_body_phase_angle(double JD, LnHypOrbit orbit);
	...
	/*
	 * ! \fn double ln_get_hyp_body_elong(double JD, LnHypOrbit orbit); \param
	...
	/*
	 * ! \fn double ln_get_hyp_body_rst(double JD, LnLnlatPosn observer,
	...
	/*
	 * ! \fn double ln_get_hyp_body_rst_horizon(double JD, LnLnlatPosn observer,
	...
	/*
	 * ! \fn double ln_get_hyp_body_next_rst(double JD, LnLnlatPosn observer,
	 * LnHypOrbit orbit, LnRstTime rst); \param JD Julian day \param observer
	 * Observers position \param orbit Orbital parameters \param rst Pointer to
	 * store Rise, Set and Transit time in JD \return 0 for success, else 1 for
	...
	/*
	 * ! \fn double ln_get_hyp_body_next_rst_horizon(double JD, LnLnlatPosn
	 * observer, LnHypOrbit orbit, double horizon, LnRstTime rst); \param JD
	...
	/*
	 * ! \fn double ln_get_hyp_body_next_rst_horizon_future(double JD,
	 * LnLnlatPosn observer, LnHypOrbit orbit, double horizon, int day_limit,

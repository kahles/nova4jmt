...
public class Utility {
	...
	/*
	 * ! \fn String ln_get_version (void) \return Null terminated version
	 * string.
	 * 
	...
	/*
	 * ! \fn void ln_hequ_to_equ(LnhEquPosn hpos, LnEquPosn pos) \brief human
	 * readable equatorial position to double equatorial position \ingroup
	 * conversion
	 */
	...
	/*
	 * ! \fn void ln_equ_to_hequ(LnEquPosn pos, LnhEquPosn hpos) \brief human
	 * double equatorial position to human readable equatorial position \ingroup
	 * conversion
	 */
	...
	/*
	 * ! \fn void ln_hhrz_to_hrz(LnhHrzPosn hpos, LnHrzPosn pos) \brief human
	 * readable horizontal position to double horizontal position \ingroup
	 * conversion
	 */
	...
	/*
	 * ! \fn void ln_hrz_to_hhrz(LnHrzPosn pos, LnhHrzPosn hpos) \brief double
	...
	/*
	 * ! \fn String ln_hrz_to_nswe(LnHrzPosn pos); \brief returns direction of
	 * given azimuth - like N,S,W,E,NSW,... \ingroup conversion
	 */
	...
	/*
	 * ! \fn void ln_hlnlat_to_lnlat(LnhLnlatPosn hpos, LnLnlatPosn pos) \brief
	 * human readable long/lat position to double long/lat position \ingroup
	 * conversion
	 */
	...
	/*
	 * ! \fn void ln_lnlat_to_hlnlat(LnLnlatPosn pos, LnhLnlatPosn hpos) \brief
	 * double long/lat position to human readable long/lat position \ingroup
	 * conversion
	 */
	...
	/*
	 * ! \fn double ln_get_dec_location(String s) \param s Location string
	...
	/*
	 * ! \fn String ln_get_humanr_location(double location) \param location
	 * Location angle in degress \return Angle string
	 * 

...
import static de.kah2.nova4jmt.RiseSet.LN_STAR_STANDART_HORIZON;
import static de.kah2.nova4jmt.RiseSet.ln_get_motion_body_next_rst_horizon;
import static de.kah2.nova4jmt.RiseSet.ln_get_motion_body_next_rst_horizon_future;
import static de.kah2.nova4jmt.RiseSet.ln_get_motion_body_rst_horizon;
import static de.kah2.nova4jmt.Transform.ln_get_rect_from_helio;
import static de.kah2.nova4jmt.Utility.ln_deg_to_rad;
import static de.kah2.nova4jmt.Utility.ln_get_light_time;
import static de.kah2.nova4jmt.Utility.ln_get_rect_distance;
import static de.kah2.nova4jmt.Utility.ln_rad_to_deg;
import static de.kah2.nova4jmt.Utility.ln_range_degrees;
...
import static de.kah2.nova4jmt.solarsystem.Solar.ln_get_solar_geo_coords;
...
import de.kah2.nova4jmt.util.IGetMotionBodyCoords;

public class ParabolicMotion {

	/**
	 * double ln_solve_barker (double q, double t); \param q Perihelion distance
	 * in AU \param t Time since perihelion in days \return Solution of Barkers
	 * equation
	 * 
	...
	/**
	 * double ln_get_par_true_anomaly (double q, double t); \param q Perihelion
	 * distance in AU \param t Time since perihelion \return True anomaly
	 * (degrees)
	 * 
	...
	/**
	 * double ln_get_par_radius_vector (double q, double t); \param q Perihelion
	 * distance in AU \param t Time since perihelion in days \return Radius
	 * vector AU
	 * 
